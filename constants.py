...
CHAR_CATEGORIES = ["abyss_guard", "abyss_crawler", "argali_knight", "berserker", "dark_spirit",
                   "defector", "desperate_doctor", "devestator", "doom_arbiter", "dragon_knight",
                   "dwarf_sniper", "eg_ranger", "egg", "elder", "empty", "evil_knight", "flame_wizard",
                   "frost_knight", "frostblaze_dragon", "god_of_thunder", "god_of_war", "goddess_of_light",
                   "grimtouch", "heaven_bomber", "hell_knight", "divine_herald", "lightblade_knight",
                   ...
                   "the_source", "thunder_spirit", "tsunami_stalker", "tusk_champion", "umbra", "venom",
